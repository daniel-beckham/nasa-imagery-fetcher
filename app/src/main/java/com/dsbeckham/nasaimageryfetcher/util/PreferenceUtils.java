...
public class PreferenceUtils {
    ...
    public static void processPreference(Activity activity, SharedPreferences sharedPreferences, String key) {
        ...
        switch (key) {
            ...
            case PREF_AUTOMATIC_DOWNLOADS:
                if (key.equals(PREF_AUTOMATIC_DOWNLOADS)) {
                ...
                if (!sharedPreferences.getBoolean(PREF_NOTIFICATIONS, false) && !sharedPreferences.getBoolean(PREF_AUTOMATIC_DOWNLOADS, false)) {
    ...
    public static void togglePreferencesBasedOnAllCurrentKeyValues(Activity activity, SharedPreferences sharedPreferences) {
